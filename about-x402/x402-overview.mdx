...
- **Agents:** Human developers and AI agents seeking to access paid services without accounts or manual payment flows.
...
4. The server verifies and settles the payment via a **facilitator**. If valid, the server returns the requested resource.
...
The x402 [Facilitator](/x402/core-concepts/facilitator) handles payment verification and settlement so that merchants don't need to maintain their own blockchain infrastructure.
...
<Check>
  Corbits supports x402 payments **on any chain**
</Check>
