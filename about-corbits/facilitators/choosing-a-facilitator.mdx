---
title: "Choosing the right facilitator"
description: "Selecting the optimal x402 facilitator to land your transactions for your application involves balancing three key considerations: capabilities, speed, and cost. This guide helps you make an informed decision based on your specific requirements."
---

## Establish key criteria

When choosing an x402 facilitator, we recommend first evaluating these factors:
